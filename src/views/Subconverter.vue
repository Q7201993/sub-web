...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "https://github.com/Q7201993/sub-web": "https://github.com/Q7201993/sub-web?",
        ...
        backendOptions: [
          ...
          { value: "https://github.com/Q7201993/sub-web" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://github.com/Q7201993/sub-web?";
